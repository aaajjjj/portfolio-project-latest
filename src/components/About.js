...
export default function About () {
    return (
        <div className="row" id="about">
            ...
            Hello, My name is Ajal RC. I am a senior at Drake University with Computer 
            ...
            HTML and CSS, and their popular frameworks. Similarly, I have used platforms like Docker,
