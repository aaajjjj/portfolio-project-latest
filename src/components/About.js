...
export default function About () {
    return (
        <div className="row" id="about">
            ...
            Science and Mathematics as majors and a minor in Physics. I am a self-taught
            ...
            and their popular frameworks like Node.js, React, Express and Django. Similarly, I have used platforms like Docker, Azure DevOps,
